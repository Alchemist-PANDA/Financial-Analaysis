...
const Sidebar = ({ onSelectTicker, refreshTrigger, currentView, onViewChange }: SidebarProps) => {
    ...
    return (
        <aside className="terminal-sidebar">
            ...
            <div style={{ padding: '24px 16px', borderBottom: '1px solid var(--border)' }}>
                <h3 className="grid-label" style={{ marginBottom: '12px' }}>Startup Hub</h3>
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <Link className="route-link" href="/startup-hub">
                        Startup Hub
                    </Link>
                    <Link className="route-link" href="/startup-hub/stocks">
                        Startup Stocks
                    </Link>
                    <Link className="route-link" href="/startup-hub/ipos">
                        IPO Watch
                    </Link>
                    <Link className="route-link" href="/startup-hub/private">
